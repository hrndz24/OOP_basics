...
import java.com.buyash.comparator.ComparatorByStyle;
import java.com.buyash.entity.AudioRecord;
import java.com.buyash.entity.Disk;
import java.com.buyash.entity.Track;
import java.com.buyash.exception.ServiceException;
import java.com.buyash.factory.RepositoryFactory;
import java.com.buyash.repository.AudioRecordRepository;
import java.com.buyash.specification.implementation.AudioRecordSpecificationByLengthRange;
import java.com.buyash.validation.DiskValidator;
...
public class ProcessingRecordsService {
    ...
    public <T extends AudioRecord> Disk<T> writeToDisk(Disk<T> disk, List<T> records) throws ServiceException {
        ...
        for (T record : records) {
            if (record == null) {
                ...
                totalRecordsSize = totalRecordsSize.add(record.getSize());
            }
        }
    ...
    public <T extends AudioRecord> int calculateTotalRecordsLength(Disk<T> disk) throws ServiceException {
        ...
        for (T record : disk.getRecords()) {
            totalLength += record.getLengthInSeconds();
        }
        return totalLength;
    }
